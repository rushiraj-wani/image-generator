...
-- CreateEnum
CREATE TYPE "EthinicityTypeEnum" AS ENUM ('White', 'Black', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsian', 'MiddleEastern', 'Pacific', 'Hispanic');

-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Black', 'Brown', 'Hazel', 'Gray');
